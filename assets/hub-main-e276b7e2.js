...
Du bist nun bereit, mit **Modul 3** weiterzumachen, um mehr über das **wissenschaftliche Schreiben** zu erfahren. ✍️📖 `,"Zirze")}WA.player.state.onVariableChange("module2").subscribe(r),WA.player.state.onVariableChange("module3").subscribe(r),r()});
